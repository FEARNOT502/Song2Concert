// SoundInfo.jsx — a "?" button (top-right) that, on hover/focus, reveals a popup
// explaining how the convolution reverb + sound design is tuned for the CURRENT
// venue. Content comes from data.js (SOUND_NOTES + SHARED_NOTES) so it stays in
...
export default function SoundInfo({ venue }) {
  ...
  return (
    <div
      className="absolute top-[72px] right-6 z-40"
    ...
    >
      <button
        ...
        className="w-8 h-8 rounded-full border border-[oklch(0.78_0.16_55)]/60 text-[oklch(0.78_0.16_55)] text-[14px] flex items-center justify-center hover:bg-[oklch(0.78_0.16_55)] hover:text-black transition-colors font-mono"
      >
        ?
      </button>
      ...
      {open && (
        <div
          className="absolute right-0 mt-2 w-[400px] max-w-[88vw] bg-[#0a0a0a]/95 border border-white/15 backdrop-blur-md p-5 text-left shadow-2xl"
